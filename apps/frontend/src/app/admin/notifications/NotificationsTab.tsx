      ...
      <Card>
        ...
        <CardContent>
          <form className="space-y-4" onSubmit={(e) => void handleSubmit(e)}>
            ...
            <div className="space-y-2">
              <label htmlFor="notif-url" className="text-sm font-medium">
                Deep link (optional)
              </label>
              <Input
                id="notif-url"
